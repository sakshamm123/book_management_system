...
def issue():
    ...
    email = inf3.get()      #take the email
    contact = inf4.get()    #take the contact no.
    issuebtn.destroy()
    labelFrame.destroy()
    lb1.destroy()
    inf1.destroy()
    ...
    issueSql = "insert into "+issueTable+" values ('"+bid+"', '"+issueto+"','"+email+"','"+contact+"')"
...
def issuebook():
    global issuebtn, labelFrame, inf1, inf2, lb1,inf3,inf4 ,quitBtn, root, Canvas1, status
...
#    Canvas1.pack(expand=True, fill=BOTH)
    ...
    lb2 = Label(labelFrame, text="Issued to 'Name'", bg="black", fg="white")
    ...
    inf2.place(relx=0.3, rely=0.4, relwidth=0.62)
        ...
        #to whom book is issued, student name
    lb3 = Label(labelFrame, text="E-mail", bg="black", fg="white")
    ...
    inf3.place(relx=0.3, rely=0.6, relwidth=0.62)
            ...
            #to whom book is issued, student name
    lb3 = Label(labelFrame, text="Conatct no.", bg="black", fg="white")
    lb3.place(relx=0.05, rely=0.8)
