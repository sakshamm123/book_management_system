        ...
        try:
            if password_entry.get() != rpassword_entry.get():
                ...
                try:
                    ...
                    cur = con.cursor()
                    cur.execute("UPDATE employee SET password = %s WHERE email = 'sakshammishra1920@gmail.com' ", password_entry.get())
                    con.commit()
...
def otp_check():
    ...
    if row == None:
        ...
        s.sendmail('&&&&&&&&&&&',email_entry.get(),msg)
def valid_otp():
