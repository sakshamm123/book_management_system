...
def send_mail():
    try:
        ...
        if row == None:
            ...
            s.starttls()
            s.login("bookmanagementsystem9@gmail.com", "asqdfrhqbinbzzkp")
...
bookid_entry = Entry(lgn_frame, highlightthickness=0, relief=FLAT, bg="#040405", fg="white",
                                    font=("yu gothic ui ", 12, "bold"))
bookid_entry.place(x=80, y=200, width=270)
...
# -------Register  Button-----
bt_register = Button(lgn_frame, text="Send Mail", font=("times new roman", 20), bg="#0048ff", fg="white",bd=0, cursor="hand2",command= send_mail).place(x=165, y=415)
